...
- Accepting feedback with a willingness to improve.
...
- Ignoring messages or deadlines without explanation.

- Gossiping or creating conflict within the team.

- Responding defensively to constructive feedback.

- Discriminating against or excluding others.
...
- Assuming positive intent when reading messages.

- Giving people enough context when asking questions.

- Responding within a reasonable timeframe.

- Respecting different communication styles and time zones.
...
- Be respectful in both written and verbal communication.

- Listen carefully to others' perspectives.

- Be mindful that teammates may have different working styles and communication preferences.
...
- Supporting teammates when possible.
...
- Prepare an agenda, progress update, questions, and any blockers.

- Research straightforward questions myself using documentation, Google, or ChatGPT before asking my supervisor.

- Arrive on time and focus fully during the meeting without multitasking.

- Take detailed notes and record any action items.
...
- Share my proposed solution when asking questions (for example: "Based on my research, I think I should do... Is that what you recommend?").

- Provide regular progress updates, ideally at the end of each working day.

- Continue learning new technologies outside assigned tasks.
...
- **Discord or Teams** for medium-priority questions that need a response within about 24 hours.

- **SMS** for urgent issues that require a response within a couple of hours.
